...
os.system("git clone https://github.com/damboc/skin.CarPC-touch_carbon -b 800x480");
xbmcgui.Dialog().notification('Skin', 'Install Update', xbmcgui.NOTIFICATION_INFO, 5000)
os.system("sudo rm -r /home/pi/.kodi/addons/skin.CarPC-touch_carbon/");
os.system("sudo mkdir /home/pi/.kodi/addons/skin.CarPC-touch_carbon/");
os.system("sudo rsync -r skin.CarPC-touch_carbon/ /home/pi/.kodi/addons/skin.CarPC-touch_carbon/");
